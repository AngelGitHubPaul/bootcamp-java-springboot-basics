...
public class JwtUserDetailsService implements UserDetailsService {
    ...
    // @Override indicates that this method overrides a method from super class or interface
    @Override
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // if user is NOT found, throw UsernameNotFoundException with appropriate message
        if(user == null) {
